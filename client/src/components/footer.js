...
export default function Footer() {
  return (
    <footer className="container pt-4 mt-5 bg-warning ">
      <div className="row">
        ...
        <div className="col col-12 text-center"> 
            <div className="footer-copyright text-center py-3" > &copy; {new Date().getFullYear()} Copyright: <img src={foto} style={{ height: "30px", with: "40px"}}></img>
            </div>
        </div>
      </div>
    </footer>
